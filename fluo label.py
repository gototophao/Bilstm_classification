...
# processed_scattering_latent=latent_sca
label_list=[]
total_label=pd.DataFrame()
for i in range(2,11):
    ncluster=i
    HCA_model = KMeans(n_clusters=ncluster)
    HCA_model.fit(processed_scattering_latent)
...
# total_label.to_hdf('C:\\Users\\q75714hz\\Desktop\\test\\'+'ae_fluo_kmeans_quantran_label.hdf',key='label_value')
total_label.to_hdf('C:\\Users\\q75714hz\\Desktop\\re-label\\'+'bi_fluo_new_kmeans_quantran_label.hdf',key='label_value')
